...
<h3 >GROWTH AND TRAFFIC</h3>
	...
	<h3 >PEDESTRIAN AND BICYCLE SAFETY CHALLENGES</h3>
	<ul>
		<li><strong>Pedestrian safety needs to be improved.</strong> The 2021 Dangerous by Design report from Smart Growth America  ranks the Orlando-Kissimmee-Sanford area at the top of the list of the most dangerous urban areas for pedestrians.<sup><a href="#footnotes3" aria-label="Footnote 3">3</a></sup></li>
		<li><strong>Bicycle safety needs to be improved.</strong> According to the Florida Department of Highway Safety and Motor Vehicles, Orange County had 355 bicyclist crashes in 2020.</li>
	</ul>
	...
	<ul>
		<li><strong>Current public transit is inadequate.</strong> LYNX bus routes do not meet the current demand, and SunRail, the regional commuter rail system, does not run often enough. Currently, SunRail runs Monday through Friday and during special events.</li>
		<li><strong>LYNX, the regional bus system,</strong> has approximately 300 buses and services 2,500 square miles. Compare this to Pittsburgh, Pennsylvania, where Allegheny County services only 745 square miles with 700 buses.</li>
		<li><strong>More funding for LYNX</strong> could increase the number of routes and frequency; and reduce most wait times by 50%. In addition, it could also create faster and more direct routes.</li>
	</ul>
	<h3 >Sales tax would improve roadway and transportation infrastructure, including:</h3>
	<ul>
	...
	<h3 >Paying for the transportation sales tax</h3>
	<ul>
	...
	<h3 >No tax on essential items for all consumers</h3>
	<ul>
		<li>No tax would be collected on essential food items, such as bread and milk, nor on other foods that are not taxed now.</li>
		<li>Prescription drugs would be exempt.</li>
		<li>Utilities would also be exempt.</li>
	</ul>
	<h3 >Spending your tax dollars wisely</h3>
	<ul>
		<li>If passed, your transportation tax dollars would go through a three-step oversight process, with review by a Technical Committee, as well as an appointed Citizens Oversight Board and the Board of County Commissioners.</li>
	</ul>
	<hr />
	<p id="footnotes">
